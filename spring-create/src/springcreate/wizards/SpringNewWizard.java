...
public class SpringNewWizard extends Wizard implements INewWizard {
	...
	private TestWizard page;
	private ISelection selection;

	/**
	 * Constructor for SpringNewWizard.
	 */
...
//		IWorkspaceRoot root = ResourcesPlugin.getWorkspace().getRoot();
		...
		IProjectDescription description = workspace.newProjectDescription(containerName);
//		description
...
//		monitor.worked(1);
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status = new Status(IStatus.ERROR, "spring-create", IStatus.OK,
				message, null);
